...
struct Test070 : Test {
	...
	inline Test070(const char * name, const char * desc, runner func)
	  : Test(name, desc,func) {
...
static const master_t Master[std::extent<decltype(Test070::tests)>::value] = {
...
const master_t Test070::master() const noexcept {
	return Master[index()];
}
}}
